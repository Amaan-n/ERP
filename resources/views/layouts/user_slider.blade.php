<div id="kt_quick_user" class="offcanvas offcanvas-right p-10 hide_print">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="javascript:void(0);"
                   class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::check() ? Auth::user()->name : 'Guest' }}</a>
                <div class="navi mt-2">
                    <a href="mailto:{{ Auth::check() ? Auth::user()->email : '' }}" class="navi-item">
            ...
            <a href="{{ route('profile') }}" class="navi-item">
                <div class="navi-link">
                    <div class="navi-text">
                        ...
                        <div class="text-muted">Update user profile & login credentials</div>
                    </div>
                </div>
            </a>
        </div>
